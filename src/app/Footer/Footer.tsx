...
import logo from "../../assets/BinItRight-logo.svg";
  ...
  const SendMsg = (e: React.FormEvent) => {
    ...
    emailjs
      ...
      .then((result: { text: any }) => {
        ...
        toast.success("Subscription Confirmed! Welcome to the BinItRight community.");
      })
    ...
    <footer className="footer projects shadow-2xl">
        ...
        <div className="container">
          <div className="footer-brand">
            ...
            <p className="footer-text">
              BinItRight: Revolutionizing e-waste management through technological innovation. Our platform connects you with certified recycling facilities, empowering your journey toward environmental responsibility and sustainable electronics disposal.
            </p>
          ...
          <ul className="footer-list">
            <li>
              <p className="footer-list-title">BinItRight Platform</p>
            </li>
            <li>
          ...
          <ul className="footer-list">
            ...
            <li className="footer-item">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="mailto:contact@BinItRight.com"
                className="contact-link"
              >
                contact@BinItRight.com
              </Link>
            </li>
            <li className="footer-item">
              <ul className="social-list mb-4 md:mb-0">
                <li>
                  <Link
                    ...
                    rel="noopener noreferrer"
                    href="#"
                    aria-label="Connect with BinItRight on LinkedIn"
                ...
                <li>
                  <Link
                    ...
                    rel="noopener noreferrer"
                    href="#"
                    aria-label="Follow BinItRight on Instagram"
                    className="social-link"
                  >
                ...
                <li>
                  <Link
                    ...
                    rel="noopener noreferrer"
                    href="#"
                    aria-label="Follow BinItRight on Twitter"
                    className="social-link"
                  >
                ...
                <li>
                  <Link
                    ...
                    rel="noopener noreferrer"
                    href="#"
                    aria-label="Contact BinItRight on WhatsApp"
                    className="social-link"
                  >
      ...
      <div className="footer-bottom">
        ...
        <p className="copyright">
            &copy; 2023 BinItRight | All Rights Reserved by{" "}
