...
const elocateFeatures = [
  {
    number: "01",
    title: "State-of-the-BinItRight E-Waste Collection Network",
    description:
      "BinItRight access our extensive network of verified and certified e-waste collection facilities, ensuring safe, responsible, and environmentally-conscious disposal for all electronic devices.",
  },
  {
    number: "02",
    title: "Comprehensive BinItRight Educational Resources",
    description:
  ...
  {
    number: "04",
    title: "BinItRight AI-Powered Smart Assistant",
    description:
  ...
  {
    number: "06",
    title: "BinItRight Advanced Facility Management Dashboard",
    description:
