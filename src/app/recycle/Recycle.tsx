...
const Recycle: React.FC = () => {
  const recycleItems: RecycleCardProps[] = [
    ...
    },
    {
      ...
      recyclingProcess:
        "We implement secure data destruction, component disassembly, circuit board processing, and proper management of BinItRight screens and batteries.",
  ...
  return (
    <>
      <Head>
        <title>BinItRight - Electronics Recycling Solutions</title>
        <meta name="description" content="Responsibly recycle your electronic devices with BinItRight's specialized recycling programs for smartphones, laptops, TVs, refrigerators and more." />
      </Head>
      ...
      <div className="section container mx-auto px-4 recycle-container">
        ...
        <div className="mt-20 bg-emerald-50 rounded-lg p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-emerald-700">Why Recycle Electronics With BinItRight?</h3>
